...
use App\Http\Controllers\Api\Client\EmpresaController as EmpresaClient; //??? no existe
//use App\Http\Controllers\Api\Admin\EmpresaController; ??? no existe
...
Route::prefix('v1')->group(function () {
    ...
    Route::middleware('auth:sanctum')->group(function () {
        Route::put('/empresa/{id}', [AuthController::class, 'updateEmpresa']);
