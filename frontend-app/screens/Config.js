...
export default {
  ...
  urlFoto: () => `http://localhost:8000`,

  registerCliente: (dato) => axios.post(`${base_api_url}/auth/register-cliente`, dato),
  registerEmpresa: (dato) => axios.post(`${base_api_url}/auth/register-empresa`, dato),
  getLogin: (dato) => axios.post(`${base_api_url}/auth/login`, dato),
