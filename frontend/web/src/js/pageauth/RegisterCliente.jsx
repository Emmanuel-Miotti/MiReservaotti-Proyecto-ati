    ...
    <div className="col-sm-12">
      <div className="mt-5">
        <div className="card-body" id="demo-form">
          ...
          {/* <hr /> */}
          <p className="auth-card-footer text-center mb-4">
            ¿Eres una EMPRESA?{" "}
            <a className="text-dark fw-bold" href="/register-empresa">
              Regístrate aquí
            </a>
          </p>
          {/* <hr /> */}
          ...
          <Form.Group className="mb-3">
            <Form.Label htmlFor="profile_picture">Foto de Perfil</Form.Label>
            <Form.Control
              type="file"
